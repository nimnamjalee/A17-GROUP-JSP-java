...
<head>
  ...
  <body>
    ...
    <form method="post" align="center">
        ...
        <br>
        <br>
        <img  src="images/kp.jpg" alt="Card image cap"><br>
        <h3>Apple(100g)</h3>
        <p>Price:Rs 139.00</p>
        <!-- Hidden fields for database-related data -->
        <input type="hidden" name="productName1" value="Apple(100g)">
        <input type="hidden" name="price1" value="139.00">
...
<br>
        <br>
    <form method="post"align="center">
        <img  src="images/kw.jpg" alt="Card image cap"><br>
        <h3>Woodapple(500g)</h3>
        <p>Price: Rs 150.00</p>
        <!-- Hidden fields for database-related data -->
        <input type="hidden" name="productName2" value="Woodapple(500g)">
        <input type="hidden" name="price2" value="150.00">
  ...
  <br>
        <br>
              <form method="post" align="center">
        <img  src="images/ks.jpg" alt="Card image cap"><br>
        <h3>Strawberry - 250g</h3>
        <p>Price: Rs 750.00</p>
        <!-- Hidden fields for database-related data -->
        <input type="hidden" name="productName3" value="Strawberry - 250g">
        <input type="hidden" name="price3" value="750.00">
        ...
        if (request.getParameter("addToCart1") != null || request.getParameter("addToCart2") != null) {
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    String insertCartSql = "INSERT INTO fresh(username, product_name, quantity, price) VALUES (?, ?, ?, ?)";
