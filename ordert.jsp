...
<html>
<head>
    <title>Display Data from OrderBy Table</title>
...
<%
   ...
   try {
      ...
      // Query to fetch all data from the orderby table
...
<%
      ...
      // Close resources in reverse order of their creation to avoid potential leaks
      if (rs != null) {
         try {
            rs.close();
...
<%
    ...
    if (request.getMethod().equalsIgnoreCase("post")) {
        ...
        try {
            ...
            String sql = "DELETE FROM orderby WHERE username=? AND id=?";
            try (PreparedStatement pstmt = conn.prepareStatement(sql)) {
                ...
                if (rowsAffected > 0) {
                    ...
                    out.println("<p>No matching order found.</p>");
                }
            }
