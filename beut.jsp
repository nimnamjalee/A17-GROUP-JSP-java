...
<head>
  ...
  <body>
    ...
    <form method="post" align="center">
        ...
        <br>
        <br>
        <img  src="images/bs.jpg" alt="Card image cap"><br>
        <h3>Dove Shampoo Intense Repair 180Ml</h3>
        <p>price:Rs 750.00</p>
        <!-- Hidden fields for database-related data -->
        <input type="hidden" name="productName1" value="Dove Shampoo Intense Repair 180Ml">
        <input type="hidden" name="price1" value="750.00">
...
<br>
        <br>
    <form method="post"align="center">
        <img  src="images/br.jpg" alt="Card image cap"><br>
        <h3>Rani Soap Sandal Gel Bar 70G</h3>
        <p>price:Rs 270.00</p>
        <!-- Hidden fields for database-related data -->
        <input type="hidden" name="productName2" value="Rani Soap Sandal Gel Bar 70G">
        <input type="hidden" name="price2" value="270.00">
  ...
  <br>
        <br>
              <form method="post" align="center">
        <img  src="images/bv.jpg" alt="Card image cap"><br>
        <h3>Vaseline aloe fresh body lotion 200ml</h3>
        <p>Price:Rs 700.00</p>
        <!-- Hidden fields for database-related data -->
        <input type="hidden" name="productName3" value="Vaseline aloe fresh body lotion 200ml">
        <input type="hidden" name="price3" value="700.00">
        ...
        if (request.getParameter("addToCart1") != null || request.getParameter("addToCart2") != null) {
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    String insertCartSql = "INSERT INTO beauty(username, product_name, quantity, price) VALUES (?, ?, ?, ?)";
