...
<%
    ...
    if (request.getMethod().equalsIgnoreCase("post")) {
        ...
        try {
            ...
            String sql = "DELETE FROM bakery WHERE username=? AND product_name=? AND quantity=?";
...
%>
<h2>Remove from Bakery items</h2>
<!-- Display the form -->
<form method="post" action="">
 ...
 <a href="freshj.jsp" class="next"><button>Vegetables and Fruits</button></a>
 <br>
		  <br>
		  <h5>Useful Links</h5>
