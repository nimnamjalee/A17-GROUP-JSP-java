...
<%
    ...
    if (request.getMethod().equalsIgnoreCase("post")) {
        ...
        try {
            ...
            String sql = "DELETE FROM fresh WHERE username=? AND product_name=? AND quantity=?";
...
%>
<h2>Remove from Fresh Fruits & Vegetables</h2>
<!-- Display the form -->
<form method="post" action="">
 ...
 <a href="beauty.jsp" class="next"><button>Beauty and Health</button></a>
 <br>
		  <br>
		  <h5>Useful Links</h5>
