 ...
 <link href="css/bootstrap-4.4.1.css" rel="stylesheet">
  ...
  <body>
    ...
    <form method="post" align="center">
        ...
        <br>
        <br>
        <img  src="images/bl.jpg" alt="Card image cap"><br>
        <h3>BLUEBERRY MUFFIN </h3>
        <p>price:Rs 240.00</p>
        <!-- Hidden fields for database-related data -->
        <input type="hidden" name="productName1" value="BLUEBERRY MUFFIN">
...
<br>
        <br>
    <form method="post"align="center">
        <img  src="images/po.jpg" alt="Card image cap"><br>
        <h3>FISH PASTRY</h3>
        <p>price:Rs 120.00</p>
        <!-- Hidden fields for database-related data -->
        <input type="hidden" name="productName2" value="FISH PASTRY">
        <input type="hidden" name="price2" value="120.00">
  ...
  <br>
        <br>
              <form method="post" align="center">
        <img  src="images/chi.jpg" alt="Card image cap"><br>
        <h3>Chocolate Chip Cookies</h3>
        <p>Price:Rs 155.00</p>
        <!-- Hidden fields for database-related data -->
        <input type="hidden" name="productName3" value="Chocolate Chip Cookies">
        <input type="hidden" name="price3" value="155.00">
